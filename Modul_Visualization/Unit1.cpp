...
void __fastcall TForm1::OpenImage1Click(TObject *Sender) {
	if (OpenPictureDialog1->Execute()) {
		...
		Form1->Caption = AnsiString("ПК \"Атлас - Фото\", Модуль визуализации. Версия 1.01.  Открыт файл: ") + fname;
...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
	...
	//AnsiString
	AddLogEntry("Запущен ПК \"Атлас - Фото\", Модуль визуализации.");
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::FormClose(TObject *Sender, TCloseAction &Action)
{
    // Закрываем файл лога
	if (logFile.is_open()) {
		AddLogEntry("ПК \"Атлас - Фото\", Модуль визуализации. Работа модуля завершена.");
		logFile.close();
	}
}
//---------------------------------------------------------------------------
